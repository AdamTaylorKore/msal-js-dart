...
class JsObjectMapProxy<V> with MapMixin<String, V> {
  ...
  Iterable<String> get keys =>
      interop.Object.keys(_jsObject).toDart.cast<String>();

  @override
  V? operator [](Object? key) {
    ArgumentError.checkNotNull(key, 'key');

    return jsDecode(_jsObject.getProperty<JSAny?>((key! as String).toJS));
  }
  ...
  V? remove(Object? key) {
    ...
    interop.Reflect.deleteProperty(_jsObject, key as String);
